...
# Expose mapping of available agent implementations so workflows can look them
# up dynamically.  New agent versions can be registered here and referenced by
# name in :class:`WorkflowConfig`.
