...
class DocumentProcessorAgent(BaseAgent, MemoryMixin):
    ...
    async def _process_pdf_async(
        ...
        return await asyncio.get_event_loop().run_in_executor(
            None, self._sync_process_pdf, file_path, options
        )
    ...
    async def _process_txt_async(
        ...
        return await asyncio.get_event_loop().run_in_executor(
            None, self._sync_process_txt, file_path, options
        )
    ...
    async def _process_markdown_async(
        ...
        return await asyncio.get_event_loop().run_in_executor(
            None, self._sync_process_markdown, file_path, options
        )
    ...
    async def _process_html_async(
        ...
        return await asyncio.get_event_loop().run_in_executor(
            None, self._sync_process_html, file_path, options
        )
    ...
    async def _process_rtf_async(
        ...
        return await asyncio.get_event_loop().run_in_executor(
            None, self._sync_process_rtf, file_path, options
        )
    ...
    async def _process_excel_async(
        ...
        return await asyncio.get_event_loop().run_in_executor(
            None, self._sync_process_excel, file_path, options
        )
    ...
    async def _process_csv_async(
        ...
        return await asyncio.get_event_loop().run_in_executor(
            None, self._sync_process_csv, file_path, options
        )
    ...
    async def _process_powerpoint_async(
        ...
        return await asyncio.get_event_loop().run_in_executor(
            None, self._sync_process_powerpoint, file_path, options
        )
    ...
    async def _process_image_async(
        ...
        return await asyncio.get_event_loop().run_in_executor(
            None, self._sync_process_image, file_path, options
        )
