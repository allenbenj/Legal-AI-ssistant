...
class IntegratedMainWindow(QtWidgets.QMainWindow):
    ...
    def initializeServices(self):
        ...
        import asyncio
        from legal_ai_system.services.service_container import create_service_container

        self.service_container = asyncio.get_event_loop().run_until_complete(
            create_service_container()
        )
        self.processing_worker = DocumentProcessingWorker(
            self.api_client, self.service_container
        )
    ...
    def showDatabaseConnections(self):
        """Show dialog for database connection configuration"""
