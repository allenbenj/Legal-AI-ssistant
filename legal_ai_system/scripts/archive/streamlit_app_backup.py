...
# Create __init__.py in legal_ai_system/gui/
# Content:
# from .streamlit_app import main_streamlit_entry, run_streamlit_app_content
# __all__ = ["main_streamlit_entry", "run_streamlit_app_content"]# legal_ai_system/gui/streamlit_app.py
import sys
import os
...
import streamlit as st  # Moved Streamlit import up
...
# Content:
# from .streamlit_app import main_streamlit_entry, run_streamlit_app_content
# __all__ = ["main_streamlit_entry", "run_streamlit_app_content"]