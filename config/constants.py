...
This module simply re-exports the symbols defined in
:mod:`legal_ai_system.constants`. Import this module rather than the
underlying ``core`` package to ensure a stable public API.
"""

from legal_ai_system import constants as _base

# Re-export the public constants and validators
